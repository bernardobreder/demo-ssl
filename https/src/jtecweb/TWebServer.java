 ...
 *
 */
public abstract class TWebServer {
   ...
   * @throws IOException
   */
  public TWebServer(ServerSocket httpServerSocket,
  ...
  public abstract WebsocketClient websocket(WebSocket socket)
    throws IOException;

  public abstract void http(HttpRequest req, HttpResponse resp)
    throws IOException;

  public TWebServer start() {
