...
public class DefaultWebServerSocket implements WebServerSocket {
  ...
  public DefaultWebServerSocket(int port) throws IOException {
    ...
    for (;;) {
      ...
      try {
        DefaultWebSocket webSocket =
          new DefaultWebSocket(socket, openHandshake(socket, bytes8));
  ...
  public static void main(String[] args) throws Exception {
    WebServerSocket server = new DefaultWebServerSocket(8080);
    try {
      for (;;) {
