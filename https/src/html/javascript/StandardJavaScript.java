 ...
 */
public class StandardJavaScript implements JavaScript {
  ...
  public String addEventClick(int id) {
    ...
    js.appendInline("$C[%d].bind('click',function(e){", id);
    {
      ...
      js.appendInline("$WS.websocket.send(\"");
      js.appendInline("method:action\\r\\n");
      js.appendInline("target:%d\\r\\n", id);
      js.appendInline("event:click\\r\\n");
      js.appendInline("x:\"+e.pageX+\"\\r\\n");
      js.appendInline("y:\"+e.pageY+\"\\r\\n");
      js.appendInline("\\r\\n\");");
    }
    js.appendInline("});");
    return js.toString();
